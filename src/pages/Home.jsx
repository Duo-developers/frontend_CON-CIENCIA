        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {/* Recursos Educativos */}
              <div className="bg-light-bg border border-gray-200 rounded-2xl p-8 text-center shadow-sm hover:shadow-xl transition-shadow duration-300">
                <div className="w-16 h-16 bg-tertiary-sky/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-tertiary-sky" fill="none" stroke="currentColor" viewBox="0 0 24 24">
