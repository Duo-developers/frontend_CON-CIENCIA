...
// Componentes de Iconos reutilizados para consistencia visual
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 bg-white p-8 rounded-2xl shadow-lg flex flex-col gap-6">
          ...
          <div className="flex items-center justify-end">
            <Link to="/reset-password" className="text-sm font-medium text-primary-blue hover:text-blue-700 transition-colors">
