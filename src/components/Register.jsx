...
// Componentes de Iconos para mejorar la UI
...
export default function Register() {
  // El componente consume el hook, obteniendo el estado y las funciones que necesita.
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6 bg-white p-8 rounded-2xl shadow-lg">
          <div className="space-y-4">
            ...
            {/* Campo de Confirmar Contraseña con icono y botón de visibilidad */}
            <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><LockIcon /></div>
          ...
          {/* Muestra de errores de forma más visual */}
